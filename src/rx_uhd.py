...
def receive_continuous(u, t0, t_now, ic, log, sample_rate=1000000.0):
    ...
    try:
        while locked and not Exit:
            ...
            output_buffer[n.mod(bi+n.arange(num_rx_samps, dtype=n.uint64), bl)]=recv_buffer[:num_rx_samps]
...
def main(ic):
    ...
    # start with initial frequency
    tune_req=uhd.types.TuneRequest(s.freq(0))
    ...
    receive_continuous(usrp, t0, t_now, ic, log, sample_rate=ic.sample_rate)
