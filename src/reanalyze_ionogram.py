...
def analyze_ionogram(ic,
    ...
    with h5py.File(fname, "r") as h:
        ...
        t0=h["t0"][()]
        hdname=stuffr.unix2iso8601_dirname(h["t0"][()], ic)
...
#            if "I" in h.keys():
#                I=n.copy(h["I"][()])
#                I_fvec=n.copy(h["I_fvec"][()])
#                I_rvec=n.copy(h["I_rvec"][()])
#                h.close()
#                return(I,I_rvec,I_fvec)

        # float16 re and im to complex64
        z_all=n.array(h["z_re"][()]+h["z_im"][()]*1j, dtype=n.complex64)
        freqs=h["freqs"][()]
        codes=h["codes"][()]
